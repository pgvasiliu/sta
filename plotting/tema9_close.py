...
for symbol in args.ticker:
    ...
    data["TEMA_9_Close_Signal"] = 0.0
    data['TEMA_9_Close_Signal'] = np.select(
    ...
    plt.plot ( data.loc[data["TEMA_9_Close_Signal"] == -2.0].index, data["TEMA_9"][data["TEMA_9_Close_Signal"] == -2.0], "v", markersize=10, color="r", label = 'SELL SIGNAL')
