...
for symbol in args.ticker:
    ...
    data["SMA_5_8_Signal"] = 0.0
    data['SMA_5_8_Signal'] = np.select(
        [ ( data['SMA_5'].shift(1) <  data['SMA_8'].shift(1) ) & ( data['SMA_5'] >  data['SMA_8'] ) ,
          ( data['SMA_5'].shift(1) >  data['SMA_8'].shift(1) ) & ( data['SMA_5'] <  data['SMA_8'] ) ],
    [2, -2])
    ...
    plt.plot ( data["SMA_8"], alpha = 0.6, linewidth = 3, color='#FF006E', label = 'SMA_8' )

    plt.plot ( data.loc[data["SMA_5_8_Signal"] ==  2.0].index, data["SMA_5"][data["SMA_5_8_Signal"] ==  2.0], "^", markersize=10, color="g", label = 'BUY SIGNAL')
    plt.plot ( data.loc[data["SMA_5_8_Signal"] == -2.0].index, data["SMA_5"][data["SMA_5_8_Signal"] == -2.0], "v", markersize=10, color="r", label = 'SELL SIGNAL')
