...
for symbol in args.ticker:
    ...
    data["SMA_21"] = data["Adj Close"].rolling(window=21).mean()
    ...
    plt.plot ( data.loc[data["SMA_8_21_Signal"] ==  2.0].index, data["SMA_8"][data["SMA_8_21_Signal"] ==  2.0], "^", markersize=10, color="g", label = 'BUY SIGNAL')
    plt.plot ( data.loc[data["SMA_8_21_Signal"] == -2.0].index, data["SMA_8"][data["SMA_8_21_Signal"] == -2.0], "v", markersize=10, color="r", label = 'SELL SIGNAL')
