...
for symbol in args.ticker:
    ...
    plt.plot ( data["SMA_15"], alpha = 0.6, linewidth = 2, color='orange',  label = 'SMA_15',  )
    plt.plot ( data["SMA_30"], alpha = 0.6, linewidth = 3, color='#FF006E', label = 'SMA_30' )

    plt.plot ( data.loc[data["SMA_15_30_Signal"] ==  2.0].index, data["SMA_15"][data["SMA_15_30_Signal"] ==  2.0], "^", markersize=10, color="g", label = 'BUY SIGNAL')
    plt.plot ( data.loc[data["SMA_15_30_Signal"] == -2.0].index, data["SMA_15"][data["SMA_15_30_Signal"] == -2.0], "v", markersize=10, color="r", label = 'SELL SIGNAL')
