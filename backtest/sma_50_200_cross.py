...
def backtest_strategy(stock, start_date, logfile):
    ...
    for i in range(len(data)):
        # Buy signal
        if data["SMA_50"][i] > data["SMA_200"][i] and data["SMA_50"][i - 1] < data["SMA_200"][i - 1] and position == 0:
            position = 1
        ...
        # Sell signal
        elif data["SMA_50"][i] < data["SMA_200"][i] and data["SMA_50"][i - 1]  > data["SMA_200"][i - 1] and position == 1:
            position = 0
